  ...
  return (
    ...
    >
      <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-white/20 dark:border-gray-700/20">
        <h2 className="flex flex-row items-center justify-between text-2xl font-semibold mb-6 border-b pb-2 border-gray-200 dark:border-neutral-700">
          Academic Projects
          <button
            onClick={() => props.setIsOpen(!props.isOpen)}
            className="flex items-center gap-2 text-sm text-blue-500 hover:text-blue-700 dark:text-blue-300 dark:hover:text-blue-400 transition-all duration-200"
          >
            {props.isOpen ? (
              <>
